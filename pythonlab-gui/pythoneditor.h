...
class AGROS_LIBRARY_API PythonEditorWidget : public QWidget
{
    Q_OBJECT
public:
    PythonEditorWidget(PythonEditorView *parent);
    ~PythonEditorWidget();
...
class AGROS_LIBRARY_API PythonEditorView : public QWidget
{
    Q_OBJECT
public:
    PythonEditorView(QWidget *parent = 0);
    ~PythonEditorView();
