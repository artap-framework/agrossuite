def read_vtk_scalar(filename):
    ...
    if (filename == '/tmp/elstat.vtk'):
        fn = '/home/karban/Documents/git/publikace (Agros)/prezentace/2016-esco-plzen/example_simple_actuator_optimization/Examples/Microstrip - elstat.png'
    if (filename == '/tmp/magstat.vtk'):
        fn = '/home/karban/Documents/git/publikace (Agros)/prezentace/2016-esco-plzen/example_simple_actuator_optimization/Examples/Microstrip - magstat.png'    
    img = mpimg.imread(fn)
