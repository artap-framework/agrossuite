...
INCLUDE_DIRECTORIES(${CMAKE_AGROS_DIRECTORY}/3rdparty/dealii/deal.II/bundled/boost-1.56.0/include)
...
IF(WIN32)
  SET(LIBRARIES_TO_LINK ${LIBRARIES_TO_LINK} ${PLUGINS_BSON_LIBRARY} ${PLUGINS_MATIO_LIBRARY})
ENDIF(WIN32) 
