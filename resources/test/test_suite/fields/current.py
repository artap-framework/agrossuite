...
class TestCurrentPlanar(Agros2DTestCase):
    def setUp(self):  
        # model
...
if __name__ == '__main__':        
    ...
    suite.addTest(ut.TestLoader().loadTestsFromTestCase(TestCurrentPlanar))
    suite.addTest(ut.TestLoader().loadTestsFromTestCase(TestCurrentAxisymmetric))
    suite.run(result)
