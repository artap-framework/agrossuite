...
SET(LIBRARIES_TO_LINK ${QT_LIBRARIES} ${OPENGL_LIBRARIES} ${PYTHON_MODLIBS} ${PYTHON_LIB} ${PLUGINS_AGROS_LIBRARY} ${XSD_LIBRARY} ${XercesC_LIBRARIES} ${PTHREAD_LIBRARY} ${MUMPS_LIBRARIES} ${DEAL_II_LIBRARIES} ${UMFPACK_LIBRARY} ${AMD_LIBRARY} ${SuiteSparse_config_LIBRARY} ${BLAS_LIBRARIES})
