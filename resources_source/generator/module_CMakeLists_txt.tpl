...
SET(LIBRARIES_TO_LINK ${DEAL_LIBRARY} ${NLOPTLIB_LIBRARY} ${AMD_LIBRARY} ${MATIO_LIBRARY}  ${ZLIB_LIBRARY} ${TRIANGLE_LIBRARY} ${DXFLIB_LIBRARY} ${QUAZIP_LIBRARY} ${BAYESOPTLIB_LIBRARY} ${NLOPTLIB_LIBRARY} ${NSGA2_LIBRARY} ${OPENGL_LIBRARIES} ${PYTHON_MODLIBS} ${PYTHON_LIB} ${PLUGINS_AGROS_LIBRARY} ${MUMPS_LIBRARIES}  ${ZLIB_LIBRARY} ${CTEMPLATE_LIBRARY} ${XercesC_LIBRARIES})
