...
# ${DEAL_II_LIBRARIES}
SET(LIBRARIES_TO_LINK ${OPENGL_LIBRARIES} ${PYTHON_MODLIBS} ${PYTHON_LIB} ${PLUGINS_AGROS_LIBRARY} ${MUMPS_LIBRARIES} ${CMAKE_AGROS_DIRECTORY}/dealii/build/lib/libdeal_II.so ${UMFPACK_LIBRARY} ${AMD_LIBRARY} ${SuiteSparse_config_LIBRARY} ${BLAS_LIBRARIES})
