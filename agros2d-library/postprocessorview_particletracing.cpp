...
{
    // particle tracing
    cmbParticleButcherTableType->setCurrentIndex(cmbParticleButcherTableType->findData(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleButcherTableType).toInt()));
    chkParticleIncludeRelativisticCorrection->setChecked(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleIncludeRelativisticCorrection).toBool());
    txtParticleNumberOfParticles->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleNumberOfParticles).toInt());
    txtParticleStartingRadius->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleStartingRadius).toDouble());
    txtParticleMass->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleMass).toDouble());
    txtParticleConstant->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleConstant).toDouble());
    txtParticlePointX->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleStartX).toDouble());
    txtParticlePointY->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleStartY).toDouble());
    txtParticleVelocityX->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleStartVelocityX).toDouble());
    txtParticleVelocityY->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleStartVelocityY).toDouble());
    chkParticleReflectOnDifferentMaterial->setChecked(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleReflectOnDifferentMaterial).toBool());
    chkParticleReflectOnBoundary->setChecked(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleReflectOnBoundary).toBool());
    txtParticleCoefficientOfRestitution->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleCoefficientOfRestitution).toDouble());
    txtParticleCustomForceX->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleCustomForceX).toDouble());
    txtParticleCustomForceY->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleCustomForceY).toDouble());
    txtParticleCustomForceZ->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleCustomForceZ).toDouble());
    txtParticleMaximumRelativeError->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleMaximumRelativeError).toDouble());
    txtParticleMaximumSteps->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleMaximumStep).toDouble());
    txtParticleMaximumNumberOfSteps->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleMaximumNumberOfSteps).toInt());
    chkParticleColorByVelocity->setChecked(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleColorByVelocity).toBool());
    chkParticleShowPoints->setChecked(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleShowPoints).toBool());
    chkParticleShowBlendedFaces->setChecked(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleShowBlendedFaces).toBool());
    txtParticleNumShowParticleAxi->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleNumShowParticlesAxi).toInt());
    ...
    txtParticleDragDensity->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleDragDensity).toDouble());
    txtParticleDragReferenceArea->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleDragReferenceArea).toDouble());
    txtParticleDragCoefficient->setValue(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleDragCoefficient).toDouble());
    chkParticleP2PElectricForce->setChecked(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleP2PElectricForce).toBool());
    chkParticleP2PMagneticForce->setChecked(m_postprocessorWidget->computation()->setting()->value(PostprocessorSetting::View_ParticleP2PMagneticForce).toBool());
...
{
    // particle tracing
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleButcherTableType, (ButcherTableType) cmbParticleButcherTableType->itemData(cmbParticleButcherTableType->currentIndex()).toInt());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleIncludeRelativisticCorrection, chkParticleIncludeRelativisticCorrection->isChecked());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleNumberOfParticles, txtParticleNumberOfParticles->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleStartingRadius, txtParticleStartingRadius->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleMass, txtParticleMass->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleConstant, txtParticleConstant->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleStartX, txtParticlePointX->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleStartY, txtParticlePointY->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleStartVelocityX, txtParticleVelocityX->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleStartVelocityY, txtParticleVelocityY->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleReflectOnDifferentMaterial, chkParticleReflectOnDifferentMaterial->isChecked());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleReflectOnBoundary, chkParticleReflectOnBoundary->isChecked());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleCoefficientOfRestitution, txtParticleCoefficientOfRestitution->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleCustomForceX, txtParticleCustomForceX->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleCustomForceY, txtParticleCustomForceY->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleCustomForceZ, txtParticleCustomForceZ->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleMaximumRelativeError, txtParticleMaximumRelativeError->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleMaximumStep, txtParticleMaximumSteps->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleMaximumNumberOfSteps, txtParticleMaximumNumberOfSteps->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleColorByVelocity, chkParticleColorByVelocity->isChecked());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleShowPoints, chkParticleShowPoints->isChecked());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleShowBlendedFaces, chkParticleShowBlendedFaces->isChecked());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleNumShowParticlesAxi, txtParticleNumShowParticleAxi->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleDragDensity, txtParticleDragDensity->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleDragCoefficient, txtParticleDragCoefficient->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleDragReferenceArea, txtParticleDragReferenceArea->value());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleP2PElectricForce, chkParticleP2PElectricForce->isChecked());
    m_postprocessorWidget->computation()->setting()->setValue(PostprocessorSetting::View_ParticleP2PMagneticForce, chkParticleP2PMagneticForce->isChecked());
