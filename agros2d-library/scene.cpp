...
void Scene::readFromFile21(const QString &fileName)
{
    ...
    */
    ...
    Agros2D::problem()->config()->setValue(ProblemConfig::TimeOrder, eleProblemInfo.toElement().attribute("time_order", "2").toInt());
...
void Scene::readFromFile31(const QString &fileName)
{
    ...
    try
    {
        ...
        // TODO: exceptions
        QString error = Agros2D::problem()->checkAndApplyStartupScript(Agros2D::problem()->setting()->value(ProblemSetting::Problem_StartupScript).toString());
