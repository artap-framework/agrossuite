...
{
    FormInfo() : id(""), i(0), j(0), sym_planar(SymFlag_NONSYM), sym_axi(SymFlag_NONSYM), variant(WeakFormVariant_Normal), coefficient(1) {}
    FormInfo(const QString &id, int i = 0, int j = 0, SymFlag sym_planar = SymFlag_NONSYM, SymFlag sym_axi = SymFlag_NONSYM)
