...
if(WIN64)
  ...
  SET(TRILINOS_LIB_SEARCH_PATH /usr/lib64 /usr/lib /usr/local/lib/ /usr/lib/x86_64-linux-gnu ${TRILINOS_ROOT}/lib)
endif(WIN64)
...
FIND_LIBRARY(TEUCHOS_LIBRARY        NAMES teuchos trilinos_teuchos trilinos_teuchoscore PATHS ${TRILINOS_LIB_SEARCH_PATH})
FIND_LIBRARY(TEUCHOS_LIBRARY_COMM        NAMES teuchoscomm trilinos_teuchoscomm PATHS ${TRILINOS_LIB_SEARCH_PATH})
FIND_LIBRARY(TEUCHOS_LIBRARY_NUMERICS       NAMES teuchosnumerics trilinos_teuchosnumerics PATHS ${TRILINOS_LIB_SEARCH_PATH})
FIND_LIBRARY(TEUCHOS_LIBRARY_PARAMETER_LIST       NAMES teuchosparameterlist trilinos_teuchosparameterlist PATHS ${TRILINOS_LIB_SEARCH_PATH})
FIND_LIBRARY(TEUCHOS_LIBRARY_REMAINDER       NAMES teuchosremainder trilinos_teuchosremainder PATHS ${TRILINOS_LIB_SEARCH_PATH})
