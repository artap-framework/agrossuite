...
SwigField::SwigField(std::string fieldId)
{
...
void SwigField::setAnalysisType(const std::string &analysisType)
{
...
void SwigField::setNumberOfRefinements(int numberOfRefinements)
{
...
void SwigField::setPolynomialOrder(int polynomialOrder)
{
...
void SwigField::setLinearityType(const std::string &linearityType)
{
...
void SwigField::setNonlinearDampingType(std::string dampingType)
{
...
void SwigField::setAdaptivityType(const std::string &adaptivityType)
{
...
void SwigField::setMatrixSolver(const std::string &matrixSolver)
{
...
void SwigField::setLinearSolverDealIIMethod(const std::string &linearSolverMethod)
{
...
void SwigField::setLinearSolverDealIIPreconditioner(const std::string &linearSolverPreconditioner)
{
...
void SwigField::setExternalMatrixSolver(const std::string &solver)
{
    QStringList solvers;
...
void SwigField::setAdaptivityEstimator(const std::string &adaptivityEstimator)
{
...
void SwigField::setAdaptivityStrategy(const std::string &adaptivityStrategy)
{
...
void SwigField::setAdaptivityStrategyHP(const std::string &adaptivityStrategyHP)
{
...
void SwigField::setInitialCondition(double initialCondition)
{
    m_fieldInfo->setValue(FieldInfo::TransientInitialCondition, initialCondition);
}

void SwigField::setTimeSkip(double timeSkip)
{
    if (timeSkip >= 0)
...
void SwigField::removeBoundary(const std::string &name)
{
    SceneBoundary *sceneBoundary = Agros::problem()->scene()->getBoundary(m_fieldInfo, QString::fromStdString(name));
...
void SwigField::removeMaterial(const std::string &name)
{
    SceneMaterial *sceneMaterial = Agros::problem()->scene()->getMaterial(m_fieldInfo, QString::fromStdString(name));
    if (!sceneMaterial)
        throw invalid_argument(QObject::tr("Material '%1' doesn't exists.").arg(QString::fromStdString(name)).toStdString());
...
void SwigField::addRecipeVolumeIntegral(const std::string &name, const std::string &variable, const vector<int> labels, int timeStep, int adaptivityStep)
{
    // TODO: checks
...
void SwigField::addRecipeSurfaceIntegral(const std::string &name, const std::string &variable, const vector<int> edges, int timeStep, int adaptivityStep)
{
    // TODO: checks
...
void SwigField::addRecipeLocalValue(const std::string &name, const std::string &variable, const std::string &component, double px, double py, int timeStep, int adaptivityStep)
{
    // TODO: checks
