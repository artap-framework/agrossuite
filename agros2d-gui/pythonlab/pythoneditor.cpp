...
void PythonEditorTextEdit::pyLintAnalyse()
{
...
#ifdef Q_WS_X11
    QString pylintBinary = datadir() + "/resources/pythonlab/pylint_lab";
#endif
#ifdef Q_WS_WIN
    QString pylintBinary = datadir() + "/resources/pythonlab/pylint_lab.bat";
#endif
    ...
    processPyLint.setWorkingDirectory(datadir() + "/resources/pythonlab");
...
void PythonEditorTextEdit::pyLintAnalyseStopped()
{
...
{
    if (true) // if (Agros2D::configComputer()->value(Config::Python_ConsoleOutput).toBool())
    {
...
void PythonEditorDialog::doRunPython()
{
    ...
    else
    {
        ...
        // set profiler
        QSettings settings;
        bool useProfiler = true; // Agros2D::configComputer()->value(Config::Python_UseProfiler).toBool();
